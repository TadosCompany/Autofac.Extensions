namespace TypedFactories.Base
{
    ...
    public class FactoryBuilder
    {
            ...
            Action<TypeBuilder, IDictionary<Type, Type>, MethodInfo> defineMethod)
        {
            ...
            TypeBuilder typeBuilder = FactoryContext.ModuleBuilder.DefineType(factoryType.Name + FactoryContext.DynamicFactoryTypeSuffix);
        ...
        private static IEnumerable<KeyValuePair<Type, Type>> CreateGenericParameterToGenericArgumentTypesMapPairs(Type type)
        {
            if (type == null)
